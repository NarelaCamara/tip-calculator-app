...
function App() {
  ...
  return (
    <div className="bg-[#9FE8DF] flex flex-col items-center justify-center min-h-screen ">
      ...
      <div className="py-8 px-6 md:px-20  md:py-12 lg:p-8 bg-white rounded-xl    flex flex-col xl:flex-row gap-8 ">
        <div>
          ...
          <div className="flex flex-row justify-between py-2">
            ...
            {isZero && (
              <p className="text-[#E17052] text-[16px] text-end">
                Can’t be zero
              </p>
            )}
          </div>
        ...
        <div className=" bg-[#00474B] p-6 rounded-xl mt-8  px-6 lg:min-w-[413px] flex flex-col justify-between">
